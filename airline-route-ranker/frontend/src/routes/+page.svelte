...
<div class="relative min-h-screen bg-sky-dark bg-[url('/starry-sky.svg')] bg-cover bg-fixed bg-opacity-90 overflow-hidden">
  ...
  <StarryBackground starCount={200} bigStarCount={40} shootingStarCount={7} />
      ...
      <div class="container mx-auto">
        <div class="flex flex-col md:flex-row items-center justify-between">
          <div class="flex items-center mb-3 md:mb-0">
            ...
            <span class="font-bold text-sm md:text-base">Sign up for FREE and get 2 search credits! Additional 5 credits for just $1.99</span>
          </div>
